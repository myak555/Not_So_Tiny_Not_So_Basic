...
#define RAM_SIZE 56200L
static const byte RAM_TOTAL_MSG[]           PROGMEM = " RAM total  : ";
static const byte RAM_AVAILABLE_MSG[]       PROGMEM = " RAM free   : ";
static byte program_Memory[RAM_SIZE];
...
static byte LCD_Text_Buffer[LCD_TEXT_BUFFER_LENGTH]; 
static byte *LCD_Line_Pointers[LCD_SCREEN_ROWS];
static byte LCD_Stack_Buffer[LCD_STACK_BUFFER_LENGTH]; 
static byte *LCD_Stack_Pointers[LCD_STACK_ROWS];
static byte LCD_Message[LCD_TEXT_BUFFER_LINE_LENGTH];
static byte LCD_NumberLine[LCD_TEXT_BUFFER_LINE_LENGTH];
static byte LCD_OutputLine[LCD_TEXT_BUFFER_LINE_LENGTH];
...
#endif
//
// memory alignment necessary for some esp8266-based devices
#ifdef ALIGN_MEMORY
